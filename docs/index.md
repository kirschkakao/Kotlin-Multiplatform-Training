...
![Desktop Highlights](images/Desktop%20Highlights.png)
...
- programming and testing in general
- classes, interfaces, inheritance
- dependency injection

However, unlike the basic IT training, which is completely self-paced based on the training materials and allows everyone to progress at their own speed over the 4 days, this course ensures that everyone is roughly at the same level by the end. The principle is that new concepts are introduced in the morning, and students work independently on tasks in the afternoon. Every morning (from Day 2 to 5), checkpoints are released that you can obtain if needed, depending on whether you require them to successfully continue with the new tasks the next day. The tasks of this course are more challenging than in the introductory courses, so we expect that no one should finish significantly before the end of the day. The trainers will be present to support you in case you have further questions or get stuck.

In general, you can use all helping tools you like (Google, AI, etc.), but keep in mind that the goal of this course is not to have a perfect solution (nothing will be graded), but rather that you develop a good understanding of the training contents. So we kindly ask you not to just copy solutions, for your own good. As with any other training, this is meant to improve your skillset.
