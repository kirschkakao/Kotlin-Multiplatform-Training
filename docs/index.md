...
- [Day 1: Setup, Kotlin Basics and Tile Parser](day1/index.md)
- [Day 2: Navigation, Architecture Basics and UI Introduction](day2/index.md)
- [Day 3: Grid, Game Board and State Management](day3/index.md)
- [Day 4: Followers, Scoring and Dependency Injection](day4/index.md)
- [Day 5: Refinement, Presentation and Feedback](day5/index.md)